...
# replace dimVar = NULL
BuildTable(data = tourism, 
           dimVar = c("municipality", "gender"))


# Exercise 2 ---------------------------------------------------------------

# Create a table consisting of only the totals for municipality and gender using
# the tourism data set. Which is better suited, dimVar or formula?
...
FormulaSelection(linked1, formula = f1)
FormulaSelection(linked1, formula = f2)
